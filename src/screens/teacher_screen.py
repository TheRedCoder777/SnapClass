        ...
        if st.button(
            ...
            with st.spinner(
                ...
                if not enrolled_students:
                    ...
                    #
                    # Previously results and attendance_to_log
                    # were created only inside the else block,
                    # but the dialog was called outside it.
                    #
                    # That caused:
                    #
                    # UnboundLocalError:
                    # cannot access local variable 'results'
                ...
                # ------------------------------------------------
                    ...
                    for node in enrolled_students:
                        ...
                        # Safety check in case Supabase returns
                        # a malformed/null nested student record.
